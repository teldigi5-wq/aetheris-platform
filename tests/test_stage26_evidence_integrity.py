...
class Stage26EvidenceIntegrityTests(unittest.TestCase):
    def setUp(self):
        self.policy = json.loads((ROOT / "configs" / "stage26-evidence-policy.json").read_text(encoding="utf-8"))
        self.runtime = json.loads((ROOT / "architecture" / "ai-runtime-certification-reference.json").read_text(encoding="utf-8"))
    ...
    def test_runtime_safety_authority_is_pinned_to_extracted_destination(self):
        ...
        self.assertFalse(self.runtime["platform_runtime_source_present"])
