...
7. `architecture/ai-runtime-certification-reference.json` pins `teldigi5-wq/aetheris-ai-runtime` to `65a6262717adcd52ac8d8a16ed6f223e299fd74d` with canonical CI status `6_OF_6_SUCCESS`;
