...
public class ModelProviderRegistry {
    private final List<ModelProviderAdapter> adapters; private final ProviderReliabilityService reliability;
    public ModelProviderRegistry(List<ModelProviderAdapter> adapters,ProviderReliabilityService reliability){this.adapters=List.copyOf(adapters);this.reliability=reliability;}
